...
//
// Archive of one tag (NC-80). An unknown slug is a 404 rather than an empty page,
// so a typo'd URL does not look like a real archive that happens to be empty.
const TagArchive: NextPage<{ archive: Archive; basePath: string }> = ({ archive, basePath }) => (
...
export const getServerSideProps: GetServerSideProps = async (context) => {
    ...
    return { props: { archive, basePath: `/tag/${slug}` } };
};
//
